...
<!-- DataTables -->
<link rel="stylesheet" href="{{asset('/')}}admin-lte-3/plugins/datatables/dataTables.bootstrap4.css">
<!-- SweetAlert2 -->
<link rel="stylesheet" href="{{asset('/')}}admin-lte-3/plugins/sweetalert2/sweetalert2.min.css">
<!-- Toastr -->
