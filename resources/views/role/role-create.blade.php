                ...
                <div class="card card-info">
                    ...
                    <!-- text input -->
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="2" class="form-control" placeholder="Enter Description">{!! old('description') !!}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            @foreach($permissions as $permission)
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="permission_id[]"  value="{{$permission->id}}" type="checkbox" id="{{$permission->id}}">
